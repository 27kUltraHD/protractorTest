...
$("#search-form").submit(function (event) {
    ...
    if ($("#search-box").val() == "") {
        ...
        alert("Your search for " + $("#search-box").val() + " returned 0 results")
    }
    event.preventDefault();
});
